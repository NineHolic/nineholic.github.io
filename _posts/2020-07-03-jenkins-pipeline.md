---
layout: post
title: Jenkins pipeline 的使用
categories: [Jenkins]
description: 记录学习 Jenkins pipeline 时整理的一些脚本
...
过滤条件：仅当 test-admin目录下的文件被 push 时，触发构建，若需立即触发构建需勾上`Override Quiet Period`

![image-20240109151555424](https://fastly.jsdelivr.net/gh/FlyNine/cloudimage/jenkins/image-20240109151555424.png)

webhook 触发 url 为：http://192.168.216.131/jenkins/generic-webhook-trigger/invoke?token=abcd&jobQuietPeriod=0
