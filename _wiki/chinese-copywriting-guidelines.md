...
categories: [Copywriting, 转载]
description: 中文文案排版指北（简体中文版）。
keywords: 中文文案排版指北
topmost: true
---
原文地址: [https://github.com/sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines)
...
其他语言：
- [繁体中文](https://github.com/NineHolic/chinese-copywriting-guidelines/blob/master/README.md)
- [English](https://github.com/NineHolic/chinese-copywriting-guidelines/blob/master/README.en-US.md)
